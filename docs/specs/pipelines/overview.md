...
| Deploy dev | `deploy-dev.yml` | Push `dev` | build + S3 sync + CF invalidation |
| Deploy prod | `deploy-prod.yml` | Push `main` | Idem para production |
...
| [04-cicd-deploy](../frontend/tasks/04-cicd-deploy.md) | Workflows CI/CD | pendente |
